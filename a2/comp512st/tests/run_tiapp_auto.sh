...
maxmoves=3 interval=100 randseed=xxxxxxxxx
...
do
	...
	echo java tests.TreasureIslandAppAuto $process $processgroup $gameid $numplayers $playernum $maxmoves $interval $randseed$playernum $failmode '>' $gameid-$playernum-display.log
