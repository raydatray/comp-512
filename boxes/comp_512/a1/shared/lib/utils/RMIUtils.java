...
public class RMIUtils {
    ...
    public static IRMIResourceManager waitForLookup(String host, Integer port, String fullBindName) {
        try {
            Boolean first = true;
    ...
    public static void addShutdownUnbindHook(Registry registry, String fullBindName) {
    ...
    public static Registry getOrCreateRegistry(String host, Integer port) throws RemoteException {
        try {
