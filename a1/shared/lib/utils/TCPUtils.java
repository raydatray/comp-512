...
public class TCPUtils {
    ...
    public static void sendResponse(ObjectOutputStream out, Object response) throws IOException {
        out.writeObject(response);
        out.flush();
    }

    public static void handleRequest(Socket socket, ITCPResourceManager adapter) {
        try {
    ...
    public static void addShutdownHook(ServerSocket serverSocket, String serverName) {
    ...
    public static void acceptConnections(ExecutorService threadPool, ServerSocket serverSocket,
            ITCPResourceManager adapter) throws IOException {
        while (true) {
            try {
                Socket clientSocket = serverSocket.accept();
                threadPool.submit(() -> TCPUtils.handleRequest(clientSocket, adapter));
