...
public class Client {
    ...
    private static final String STARTUP_BANNER = """
        ...
        \\__|   \\__| \\__| \\__|      \\_______/  \\______/
              ...
              $$ |\\__|            $$ |              \\__|$$ |                  $$ |                    $$ |
         $$$$$$$ |$$\\  $$$$$$$\\ $$$$$$\\    $$$$$$\\  $$\\ $$$$$$$\\  $$\\   $$\\ $$$$$$\\    $$$$$$\\   $$$$$$$ |
        $$  __$$ |$$ |$$  _____|\\_ $$  _|  $$  __$$\\ $$ |$$  __$$\\ $$ |  $$ |\\_$$  _|  $$  __$$\\ $$  __$$ |
        $$ /  $$ |$$ |\\$$$$$$\\    $$ |    $$ |  \\__|$$ |$$ |  $$ |$$ |  $$ |  $$ |    $$$$$$$$ |$$ /  $$ |
        $$ |  $$ |$$ | \\____$$\\   $$ |$$\\ $$ |      $$ |$$ |  $$ |$$ |  $$ |  $$ |$$\\ $$   ____|$$ |  $$ |
        \\$$$$$$$ |$$ |$$$$$$$  |  \\$$$$  |$$ |      $$ |$$$$$$$  |\\$$$$$$  |  \\$$$$  |\\$$$$$$$\\ \\$$$$$$$ |
         \\_______|\\___|\\_ ______/    \\____/ \\__|      \\__|\\_______/  \\______/    \\____/  \\_______| \\_______|
        $$\\                           $$\\
        $$ |                          $$ |
        $$$$$$$\\   $$$$$$\\  $$\\   $$\\ $$$$$$$\\
        $$  __$$\\ $$  __$$\\ $$ |  $$ |$$  __$$\\
    ...
    public void start() {
        ...
        while (true) {
            ...
            try {
                ...
                Command cmd = Command.fromString(
                    (String) arguments.elementAt(0)
                );
                try {
        ...
        switch (cmd) {
            case Help: {
                if (arguments.size() == 1) {
                    ...
                    Command l_cmd = Command.fromString(
            ...
            case AddFlight: {
                ...
                Integer flightSeats = toInt(arguments.elementAt(2));
            ...
            case AddCars: {
                ...
                System.out.println(
                    "-Number of Cars: " + arguments.elementAt(2)
                );
            ...
            case AddRooms: {
                ...
                System.out.println(
                    "-Number of Rooms: " + arguments.elementAt(2)
                );
            ...
            case DeleteCars: {
                ...
                System.out.println(
                    "Deleting all cars at a particular location"
                );
                System.out.println("-Car Location: " + arguments.elementAt(1));
            ...
            case DeleteRooms: {
                ...
                System.out.println(
                    "Deleting all rooms at a particular location"
                );
                System.out.println("-Car Location: " + arguments.elementAt(1));
            ...
            case Bundle: {
                ...
                System.out.println("-Customer ID: " + arguments.elementAt(1));
                for (Integer i = 0; i < arguments.size() - 5; ++i) {
                    System.out.println(
                        "-Flight Number: " + arguments.elementAt(2 + i)
                    );
                }
                System.out.println(
                ...
                System.out.println(
                    "-Book Room: " + arguments.elementAt(arguments.size() - 1)
                );
                ...
                Boolean car = toBoolean(
                    arguments.elementAt(arguments.size() - 2)
                );
                Boolean room = toBoolean(
    ...
    public static void checkArgumentsCount(Integer expected, Integer actual)
    ...
    public static Integer toInt(String string) throws NumberFormatException {
    ...
    public static Boolean toBoolean(String string)
        ...
        if (string == null) {
            throw new IllegalArgumentException(
                "Boolean string value cannnot be null."
            );
        }
